...
void Net_game::paintEvent(QPaintEvent*event)
{
...
void Net_game::keyPressEvent(QKeyEvent *event)
{
...
void Net_game::Collision(int _dRow, int _dCol,int num)
{
    //判断位置
...
void Net_game::win()//胜利检测函数：没有优化过，可能会出现突然卡住的情况：我们优化的考量是：开局就检测所有4，然后观察这些4是否exist；
{
